...
INSERT INTO `chatter_messages` (`id`, `user_id`, `body`, `image_url`, `created_at`) VALUES
...
INSERT INTO `chatter_users` (`id`, `username`, `password`, `email`, `profile_icon`, `apikey`) VALUES
